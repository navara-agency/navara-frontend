 ...
 * Orbs render static when `reduced` is true or on mobile/tablet viewports
 * (animating large blurred layers continuously is too expensive there).
 */
export default function HeroWaveBackdrop({ reduced = false }) {
  const lite = useLiteMotion() || reduced
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={lite ? undefined : { x: [0, -20, 0], y: [0, 20, 0] }}
